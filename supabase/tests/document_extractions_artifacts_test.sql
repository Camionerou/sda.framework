...
values
  (
    ...
    '00000000-0000-0000-0000-000000001001',
    (select id from public.workspaces where tenant_id = '00000000-0000-0000-0000-000000001001' and slug = 'default'),
    '00000000-0000-0000-0000-000000001101',
    'alpha-a.pdf',
  ...
  (
    ...
    '00000000-0000-0000-0000-000000001002',
    (select id from public.workspaces where tenant_id = '00000000-0000-0000-0000-000000001002' and slug = 'default'),
    '00000000-0000-0000-0000-000000001102',
    'beta.pdf',
