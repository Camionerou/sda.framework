...
CONCURRENCY="${SDA_COMPUTE_GATEWAY_CONCURRENCY:-2}"
MINERU_BACKEND="${SDA_MINERU_BACKEND:-hybrid-http-client}"
MINERU_API_URL="${SDA_MINERU_API_URL:-http://127.0.0.1:8765}"
...
INNGEST_EVENT_KEY="${SDA_COMPUTE_GATEWAY_INNGEST_EVENT_KEY:-${INNGEST_EVENT_KEY:-$REMOTE_INNGEST_EVENT_KEY}}"
SDA_TREE_INDEXER_TOKEN="${SDA_TREE_INDEXER_TOKEN:-$REMOTE_TREE_INDEXER_TOKEN}"
...
SDA_MINERU_API_URL=$MINERU_API_URL
