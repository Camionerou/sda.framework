...
SDA_COMPUTE_GATEWAY_VERSION=${SDA_COMPUTE_GATEWAY_VERSION:-0.1.3}
SDA_EXTRACTION_PIPELINE_VERSION=${SDA_EXTRACTION_PIPELINE_VERSION:-0.1.6}
SDA_INDEXING_PIPELINE_VERSION=${SDA_INDEXING_PIPELINE_VERSION:-0.1.7}
